...
sealed class BottomNavItem(val route: String, val icon: ImageVector, val label: String) {
    ...
    object Popular : BottomNavItem("popular", Icons.Default.Home, "Popular")
    ...
    object ProfileNav : BottomNavItem("profile_nav", Icons.Default.Person, "Profile") // Wrapper for Profile/Login flow
}