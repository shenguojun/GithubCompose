 ...
 * @param onQueryChange Callback invoked when the text in the search field changes.
 * @param onSearch Callback invoked when the search action is triggered (e.g., keyboard search button).
